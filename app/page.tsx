  ...
  return (
    <main className="flex min-h-screen flex-col items-center">
      <div className="w-full bg-gradient-to-b from-amber-100 to-amber-50 py-12 px-4 text-center">
        <h1 className="text-3xl font-bold tracking-tight text-amber-900 sm:text-4xl">Dine with Ease</h1>
        <p className="mt-4 text-lg text-amber-700">Book, eat, and pay - all from your phone</p>
        <div className="mt-8">
        ...
        <div className="space-y-8">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Pay your bill instantly through Stripe and leave when you're ready
              </p>
            </div>
          </div>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">Leave feedback and earn rewards for your next visit</p>
            </div>
          </div>
        </div>
